...
public class SecurityConfig {
    private static final List<String> ORIGIN_PATTERN = Arrays.asList("https://kakao-funding-git-dev-teamfunding.vercel.app","https://kakao-funding-git-refactor-241-teamfunding.vercel.app","*");
